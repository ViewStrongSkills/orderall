...
<div class="container">
  <div class="page-head-content">
		<h2>Orderall Terms of Service</h2>
	</div>
<div class="static-content">
<div class="privacy-content">
  <h5>1. Terms</h5>
  <p>By accessing the website at <a href="http://www.orderall.io">http://www.orderall.io</a>, you are agreeing to be
  ...
  <ol type="a">
     <li>Permission is granted to temporarily download one copy of the materials (information or software)
        on Orderall's website for personal, non-commercial transitory viewing only.
     ...
     <ol type="i">
         ...
         <li>use the materials for any commercial purpose, or for any public display (commercial or
            non-commercial);</li>
         <li>attempt to decompile or reverse engineer any software contained on Orderall's website;</li>
         <li>remove any copyright or other proprietary notations from the materials; or</li>
         <li>transfer the materials to another person or "mirror" the materials on any other server.</li>
     </ol>
      </li>
     <li>This license shall automatically terminate if you violate any of these restrictions
       and may be terminated by Orderall at any time. Upon terminating your viewing
        of these materials or upon the termination of this license, you must destroy
         any downloaded materials in your possession whether in electronic or printed format.</li>
  </ol>
  <h5>3. Disclaimer</h5>
  <ol type="a">
     <li>The materials on Orderall's website are provided on an 'as is' basis.
       Orderall makes no warranties, expressed or implied, and hereby disclaims and
     ...
     <li>Further, Orderall does not warrant or make any representations concerning
        the accuracy, likely results, or reliability of the use of the materials
        on its website or otherwise relating to such materials or on any sites linked
         to this site.</li>
  </ol>
  <h5>4. Limitations</h5>
  <p>In no event shall Orderall or its suppliers be liable for any damages
     (including, without limitation, damages for loss of data or profit, or due
      ...
      the materials on Orderall's website, even if Orderall or a Orderall
  ...
  <p>The materials appearing on Orderall's website could include technical,
     typographical, or photographic errors. Orderall does not warrant that
     any of the materials on its website are accurate, complete or current.
      Orderall may make changes to the materials contained on its website at
       any time without notice. However Orderall does not make any commitment
       to update the materials.</p>
  <h5>6. Links</h5>
  <p>Orderall has not reviewed all of the sites linked to its website and is
     not responsible for the contents of any such linked site. The inclusion
      of any link does not imply endorsement by Orderall of the site. Use of
      any such linked website is at the user's own risk.</p>
  <h5>7. Modifications</h5>
  <p>Orderall may revise these terms of service for its website at any time
