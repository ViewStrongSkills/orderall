<div class="cart-box custwidth">
    ...
    @if (count($element->extras) > 0)
        <div class="extras-add-div show-extras">
            <span class="extras-add-div show-extras">Extras</span>
            <img class="show-extra-arrow comments-arrow show-extras" src="{{asset('images/extra-right-arrow.svg')}}" />
            @if (count($element->extras) > 0)
